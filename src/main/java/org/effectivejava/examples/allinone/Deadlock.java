...
public class Deadlock {
    ...
    /*
     ...
     1-  keep the amount of work that you do from within synchronized regions to a minimum.
     2-  When you are designing a mutable class, think about whether it should do its own synchronization.
